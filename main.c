	...
	while(exit_flag == 0) 
	{
		...
		switch(option)
		{
			case 1: //print all the schedules
				...
				printf("0 : drama (드라마 촬영 관련)")
				printf("1 : movie (영화 촬영 관련)")
				printf("2 : advertisement (광고 촬영 관련")
				printf("3 : entertainment (예능 촬영 관련)")
				printf("4 : meeting (소속사 회의)")
				printf("5 : fitness (운동)")
				printf("6 : privacy (개인사)")
